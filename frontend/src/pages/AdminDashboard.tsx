...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    if (activeTab === 'finanzas' || activeTab === 'gestion_pagos') fetchChoferesFinanzas();
  ...
  useEffect(() => {
    if (!orgId || (activeTab !== 'fleet' && activeFleetSubTab !== 'gestion')) return;
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-3xl shadow-2xl animate-in fade-in zoom-in-95 duration-500 w-full overflow-hidden relative">
      ...
      <div className="flex gap-4 mb-8 border-b border-zinc-800 pb-4 overflow-x-auto">
        ...
        <button onClick={() => { setActiveTab("fleet"); setActiveFleetSubTab("control"); }} className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold transition-all whitespace-nowrap ${activeTab === 'fleet' ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/20' : 'bg-transparent text-zinc-400 hover:bg-zinc-800 hover:text-white'}`}>
        ...
        <button onClick={() => setActiveTab("gestion_pagos")} className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold transition-all whitespace-nowrap ${activeTab === 'gestion_pagos' ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/20' : 'bg-transparent text-zinc-400 hover:bg-zinc-800 hover:text-white'}`}>
          <Wallet size={18} /> Gestión de Pagos
        </button>
        <button onClick={() => setActiveTab("clientes")} className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold transition-all whitespace-nowrap ${activeTab === 'clientes' ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/20' : 'bg-transparent text-zinc-400 hover:bg-zinc-800 hover:text-white'}`}>
      ...
      <div className="bg-zinc-950/50 p-6 md:p-8 rounded-2xl border border-zinc-800/80">
        ...
        {activeTab === "fleet" && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-300">
            {/* Subtabs para Gestión de Flota */}
            <div className="flex bg-zinc-900/50 p-1.5 rounded-2xl border border-zinc-800 w-fit mb-8">
              <button 
                onClick={() => setActiveFleetSubTab("control")}
                className={`flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-bold transition-all ${activeFleetSubTab === 'control' ? 'bg-blue-600 text-white' : 'text-zinc-500 hover:text-zinc-300'}`}
              >
                👥 Control de Unidades
              </button>
              <button 
                onClick={() => setActiveFleetSubTab("gestion")}
                className={`flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-bold transition-all ${activeFleetSubTab === 'gestion' ? 'bg-blue-600 text-white' : 'text-zinc-500 hover:text-zinc-300'}`}
              >
                🚗 Gestión de Vehículos
              </button>
            </div>

            {/* SUBTAB: Control de Unidades */}
        ...
        {activeTab === "gestion_pagos" && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-300">
                <div className="flex bg-zinc-900/50 p-1.5 rounded-2xl border border-zinc-800 w-fit mb-8">
                    <button 
                        onClick={() => setActiveSubTab("validacion")}
                        className={`flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-bold transition-all ${activeSubTab === 'validacion' ? 'bg-blue-600 text-white' : 'text-zinc-500 hover:text-zinc-300'}`}
                    >
                        📄 Validación de Pagos
                    </button>
                    <button 
                        onClick={() => setActiveSubTab("caja")}
                        className={`flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-bold transition-all ${activeSubTab === 'caja' ? 'bg-blue-600 text-white' : 'text-zinc-500 hover:text-zinc-300'}`}
                    >
                        💰 Caja de Choferes
                    </button>
                </div>
