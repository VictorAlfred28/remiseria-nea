...
5. Si el cliente quiere CANCELAR un viaje que ya pidió, llama a `cancelar_mi_viaje_activo`. Explícale que el proceso es inmediato.
    ...
    if ai_msg.tool_calls:
        ...
        if tool.function.name == "cancelar_mi_viaje_activo":
            ...
            v_res = supabase.table("viajes") \
                ...
                .in_("estado", ["solicitado", "REQUESTED", "asignado", "ACCEPTED", "en_camino", "en_puerta", "ARRIVED"]) \
