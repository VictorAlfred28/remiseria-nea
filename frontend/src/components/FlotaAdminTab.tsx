...
export default function FlotaAdminTab({ onVehicleAction }: FlotaAdminTabProps) {
  ...
  useEffect(() => { 
    ...
    // Setup realtime listener para tabla vehicles
    const subscription = supabase
      ...
      .on(
        ...
        (payload) => {
          // Re-fetch cuando hay cambios en vehicles
          fetchFlota();
        }
      )
      .subscribe();
  ...
  return (
    <div className="space-y-6">
      ...
      {loading && vehicles.length === 0 ? (
        ...
        <div className="table-container bg-zinc-900/50 border border-zinc-800 rounded-3xl overflow-x-auto w-full">
      ...
      {showCreate && (
        <div className="fixed inset-0 z-[1000] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="modal bg-zinc-900 border border-zinc-800 rounded-3xl p-4 sm:p-8 max-w-md w-full relative shadow-2xl">
      ...
      {subView === 'asignar' && selectedV && (
        <div className="fixed inset-0 z-[1000] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="modal bg-zinc-900 border border-zinc-800 rounded-3xl p-4 sm:p-8 max-w-sm w-full relative shadow-2xl">
